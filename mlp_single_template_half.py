...
def main():
	...
	outputs_train_all = dd.get_outputs(data_train, TEMPLATE)
	outputs_train = dd.get_half_outputs(outputs_train_all, inputs_train)
	...
	outputs_test_all = dd.get_outputs(data_test, TEMPLATE)
	outputs_test = dd.get_half_outputs(outputs_test_all, inputs_test)
